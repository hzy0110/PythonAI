...
def all_code_m(allCode, allType):
...
start = time.time()
p1 = Process(target=all_code_m, args=(allCode1, allType1))
p2 = Process(target=all_code_m, args=(allCode2, allType2))
p3 = Process(target=all_code_m, args=(allCode3, allType3))
p4 = Process(target=all_code_m, args=(allCode4, allType4))
p5 = Process(target=all_code_m, args=(allCode5, allType5))
p6 = Process(target=all_code_m, args=(allCode6, allType6))
p7 = Process(target=all_code_m, args=(allCode7, allType7))
p8 = Process(target=all_code_m, args=(allCode8, allType8))
print('等待所有子进程完成。')
p1.start()
p2.start()
p3.start()

...
from KaggleLearn.HousePrices.tools import oh_encode, normalize, num_features
...
df_train = pd.read_csv('/Users/hzy/code/PycharmProjects/KaggleLearn/HousePrices/input/test.csv', keep_default_na=False)
ids = df_train['Id']
...
vars = pickle.load(open('./output/weights.pickle', 'rb'))
